...
if(!class_exists('EBlueInfo_Plugin')) {
    class EBlueInfo_Plugin {
        ...
        private $pdf_service_url        = 'http://basalto01.bireme.br:9293/solr/pdfs/select?fl=id,ti,com,col,ur,tu,fo,au,ab,mt,is,at,oi,sn,an,fi_admin_id,alternate_ids';
        // private $pdf_service_url     = 'http://basalto01.bireme.br:9293/solr/pdfs/select?hl=on&hl.fl=_text_&hl.fragsize=500&hl.snippets=10&hl.maxAnalyzedChars=800000&fl=id,ti,com,col,ur,tu,fo,au,ab,mt,is,at,oi,sn,an,fi_admin_id,alternate_ids';
