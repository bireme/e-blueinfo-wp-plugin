    ...
    function paginate($page_url_params){
        ...
        if ($pag['total_pages'] > 0){
            if ($this->current_page > 1){
                $this->output .= '<li><a href="' . $page_url_params . '&page=1" title="' . __('go to page', 'lis') . ' 1">&laquo;&laquo;</a></li>';
                $this->output .= '<li><a href="' . $page_url_params . '&page=' . ($this->current_page-1) . '" title="' .  __('go to page', 'lis') . ' ' . ($this->current_page-1) . '"> &laquo; </a></li>';
            }else{
            ...
            if ( $this->current_page != '' ){
                ...
                $this->output .= '<li><a href="' . $page_url_params . '&page=2" title="' . __('go to page', 'lis') . ' 2"> &raquo; </a></li>';
