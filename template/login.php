    ...
    <form class="col s10 offset-s1 m6 offset-m3 l4 offset-l4" method="POST" action="<?php echo $services_platform_url.'/client/controller/authentication/origin/'.base64_encode($current_url); ?>">
        ...
        <div class="row">
            ...
            <div class="input-field col s12 center-align">
                ...
                <a href="<?php echo $services_platform_url; ?>/server/pub/userData.php?c=<?php echo base64_encode($current_url); ?>&theme=e-blueinfo&lang=<?php echo $lang; ?>"><?php _e('Register Yourself', 'e-blueinfo'); ?></a>
            </div>
            <div class="input-field col s12">
                <label>
