...
global $memoria_azul_service_url, $memoria_azul_plugin_slug, $memoria_azul_plugin_title, $similar_docs_url;
...
$memoria_azul_about          = $memoria_azul_config['about'];
$memoria_azul_tutorials      = $memoria_azul_config['tutorials'];
...
$memoria_azul_service_request = $memoria_azul_service_url . 'api/bibliographic/search/?id=' . $resource_id . '&op=related&lang=' . $lang;
        ...
        <div class="ajusta2">
            <section class="header-search">
                <form role="search" method="get" name="searchForm" id="searchForm" action="<?php echo real_site_url($memoria_azul_plugin_slug); ?>">
                    ...
                    <input value="" name="q" class="input-search" id="s" type="text" placeholder="<?php _e('Enter one or more words', 'memoria-azul'); ?>">
            ...
            <div class="content-area detail">
                <section id="conteudo">
                    <div class="row-fluid">
                        ...
                        <script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=<?php echo $memoria_azul_addthis_id; ?>"></script>
                        <!-- AddThis Button END -->
                    </div>
                    <div class="row-fluid">
                        <article class="conteudo-loop">
                            <h2 class="h2-loop-tit">
                                <a href="<?php echo real_site_url($memoria_azul_plugin_slug); ?>resource/<?php echo $resource->django_id; ?>"><?php echo $resource->reference_title[0]; ?></a>
                            ...
                            <?php if ( $resource->reference_abstract ): ?>
                                <div class="row-fluid abstract">
                                    <strong><?php _e('Abstract','memoria-azul'); ?></strong>
                    ...
                    <?php if ( count($similar_docs['document']) > 0 ): ?>
                        <section class="row-fluid marginbottom25 widget_categories">
                            <header class="row-fluid border-bottom marginbottom15">
                                <h1 class="h1-header"><?php _e('Related','memoria-azul'); ?></h1>
                            </header>
                            <ul>
