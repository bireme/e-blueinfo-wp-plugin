    ...
    <div class="container">
        ...
        <header class="page-header">
            ...
            <div class="searchBarMain">
        		<i class="material-icons searchBarSearchIcon noUserSelect" onclick="gtag('send','event','Search Results','Search',document.getElementById('searchBarInput').value);">search</i>
                ...
                <?php foreach ( $docs as $index => $doc ) : $index++; $id = "s".$doc->id; ?>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 item">
                        <div id="<?php echo $id; ?>" class="image-flip">
                            <div class="mainflip">
                                <div class="doc-meta" onclick="gtag('send','event','Search Results','Full Text','<?php echo $doc->ur[0]; ?>');">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="meta">
                                                ...
                                                <?php endif; ?>
                                                <a class="btn btn-primary btn-sm btn-details redirect" href="<?php echo real_site_url($eblueinfo_plugin_slug) . 'doc/' . $doc->id . '?community=' . $community_id . '&collection=' . $collection_id . '&lang=' . $lang; ?>" onclick="gtag('send','event','Search Results','View','<?php echo real_site_url($eblueinfo_plugin_slug) . 'doc/' . $doc->id; ?>');"><?php _e('See details', 'e-blueinfo'); ?></a>
                                                <a class="btn btn-primary btn-sm btn-meta redirect" href="<?php echo real_site_url($eblueinfo_plugin_slug) . 'doc/' . $doc->id . '?community=' . $community_id . '&collection=' . $collection_id . '&lang=' . $lang; ?>" onclick="gtag('send','event','Search Results','View','<?php echo real_site_url($eblueinfo_plugin_slug) . 'doc/' . $doc->id; ?>');"><i class="fa fa-info-circle"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
